...
![Exemplo de utilização das funções UPPER e LEFT no Google Sheets para obter extrair apenas o tipo de classe de artefacto lítico (i.e., lâmina, lamela) sem indicação da porção analisada (i.e., proximal, distal, mesial).](images/Screenshot 2023-08-09 at 16.52.18.png){width="10cm"}
...
## Aula 07 - Análise de variáveis {.unnumbered}

Como anteriormente ficou patente, os dados arqueológicos apresentam-se sob várias formas quando registados numa base de dados. De facto, um dos primeiros passos na configuração de um ficheiro que vai receber qualquer tipo de dados é a decisão de que tipo de dados cada coluna irá receber. Em linguagem de base de dados, a divisão dos vários tipos está sobretudo relacionada com a forma como a informação será guardada. No entanto, no momento de analisar essas mesmas variáveis através de métodos aritméticos e estatísticos, a sua classificação obedece a princípios ligeiramente diferentes. Assim, de um ponto de vista estatístico podemos classificar os dados como:
...
## Aula 09 - Representação dos resultados - Tabelas {.unnumbered}

##  {.unnumbered}

## Aula 10 - Representação gráfica de resultados {.unnumbered}

## Aula 11 - Inferência estatística {.unnumbered}
